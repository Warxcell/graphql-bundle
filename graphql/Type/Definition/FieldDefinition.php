...
class FieldDefinition
{
    ...
    public function __construct(array $config)
    {
        ...
        $this->cacheResolver = $config['cacheResolver'] ?? null;
    ...
    public function assertValid(Type $parentType): void
    {
        ...
        if (!$type instanceof OutputType) {
            ...
            throw new InvariantViolation(
                "{$parentType->name}.{$this->name} field type must be Output Type but got: {$safeType}."
            );
        }
        ...
        if ($this->resolveFn !== null && !\is_callable($this->resolveFn)) {
            ...
            throw new InvariantViolation(
                "{$parentType->name}.{$this->name} field resolver must be a function if provided, but got: {$safeResolveFn}."
            );
        }
