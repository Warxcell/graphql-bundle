 ...
 */
class OptimizedExecutor implements ExecutorImplementation
{
    ...
    public static function create(
        ...
        if (\is_array($exeContext)) {
            return new class($promiseAdapter->createFulfilled(
                new ExecutionResult(null, $exeContext)
    ...
    protected function buildResponse(mixed $data): ExecutionResult
    {
        if ($data !== null) {
            $data = (array)$data;
        }
     ...
     */
    protected function executeFieldsSerially(
        ...
        $result = $this->promiseReduce(
            ...
            function ($results, $responseName) use (
                $contextValue,
                $path,
                $unaliasedPath,
                $parentType,
    ...
    protected function completeValue(
        ...
        \assert(
            ...
            SchemaValidationContext::duplicateType(
    ...
    protected function completeListValue(
        ...
        foreach ($results as $item) {
            ...
            $completedItem = $this->completeValueCatchingError(
                $itemType,
                $fieldNodes,
                $info,
                $itemPath,
