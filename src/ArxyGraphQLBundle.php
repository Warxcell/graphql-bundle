        ...
        $container->addCompilerPass(new class implements CompilerPassInterface {
            public function process(ContainerBuilder $container)
            {
                ...
                foreach ($container->findTaggedServiceIds('arxy.graphql.resolver') as $serviceId => $tags) {
                    ...
                    if (!$interface) {
                        throw new LogicException(sprintf('Could not determine graphql object name for %s', $reflection->getName()));
                    }
                    ...
                    } elseif ($reflection->implementsInterface(UnionResolverInterface::class) || $reflection->implementsInterface(InterfaceResolverInterface::class)) {
                        $resolvers[$graphqlName] = new Reference($serviceId);
                    } else {
